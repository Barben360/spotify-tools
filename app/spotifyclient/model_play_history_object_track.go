...
type _PlayHistoryObjectTrack PlayHistoryObjectTrack
...
func (o *PlayHistoryObjectTrack) UnmarshalJSON(bytes []byte) (err error) {
	varPlayHistoryObjectTrack := _PlayHistoryObjectTrack{}

	if err = json.Unmarshal(bytes, &varPlayHistoryObjectTrack); err == nil {
		*o = PlayHistoryObjectTrack(varPlayHistoryObjectTrack)
	}
