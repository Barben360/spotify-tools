...
type _ChapterObjectAllOfAudiobook ChapterObjectAllOfAudiobook
...
func (o *ChapterObjectAllOfAudiobook) UnmarshalJSON(bytes []byte) (err error) {
	varChapterObjectAllOfAudiobook := _ChapterObjectAllOfAudiobook{}

	if err = json.Unmarshal(bytes, &varChapterObjectAllOfAudiobook); err == nil {
		*o = ChapterObjectAllOfAudiobook(varChapterObjectAllOfAudiobook)
	}
