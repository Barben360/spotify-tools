...
type _PlaylistObjectTracks PlaylistObjectTracks
...
func (o *PlaylistObjectTracks) UnmarshalJSON(bytes []byte) (err error) {
	varPlaylistObjectTracks := _PlaylistObjectTracks{}

	if err = json.Unmarshal(bytes, &varPlaylistObjectTracks); err == nil {
		*o = PlaylistObjectTracks(varPlaylistObjectTracks)
	}
