...
type _ArtistObject ArtistObject
...
func (o *ArtistObject) UnmarshalJSON(bytes []byte) (err error) {
	varArtistObject := _ArtistObject{}

	if err = json.Unmarshal(bytes, &varArtistObject); err == nil {
		*o = ArtistObject(varArtistObject)
	}
