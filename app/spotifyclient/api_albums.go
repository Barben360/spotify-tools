...
func (r AlbumsApiGetAnArtistsAlbumsRequest) Execute() (*PagingSimplifiedAlbumObject, *http.Response, error) {
...
func (a *AlbumsApiService) GetAnArtistsAlbumsExecute(r AlbumsApiGetAnArtistsAlbumsRequest) (*PagingSimplifiedAlbumObject, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r AlbumsApiGetNewReleasesRequest) Country(country string) AlbumsApiGetNewReleasesRequest {
	r.country = &country
	return r
}
...
func (r AlbumsApiRemoveAlbumsUserRequest) RequestBody(requestBody map[string]interface{}) AlbumsApiRemoveAlbumsUserRequest {
...
func (r AlbumsApiSaveAlbumsUserRequest) RequestBody(requestBody map[string]interface{}) AlbumsApiSaveAlbumsUserRequest {
	r.requestBody = &requestBody
	return r
}
