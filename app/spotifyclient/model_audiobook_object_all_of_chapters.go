...
type _AudiobookObjectAllOfChapters AudiobookObjectAllOfChapters
...
func (o *AudiobookObjectAllOfChapters) UnmarshalJSON(bytes []byte) (err error) {
	varAudiobookObjectAllOfChapters := _AudiobookObjectAllOfChapters{}

	if err = json.Unmarshal(bytes, &varAudiobookObjectAllOfChapters); err == nil {
		*o = AudiobookObjectAllOfChapters(varAudiobookObjectAllOfChapters)
	}
