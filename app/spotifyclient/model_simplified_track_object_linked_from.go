...
type _SimplifiedTrackObjectLinkedFrom SimplifiedTrackObjectLinkedFrom
...
func (o *SimplifiedTrackObjectLinkedFrom) UnmarshalJSON(bytes []byte) (err error) {
	varSimplifiedTrackObjectLinkedFrom := _SimplifiedTrackObjectLinkedFrom{}

	if err = json.Unmarshal(bytes, &varSimplifiedTrackObjectLinkedFrom); err == nil {
		*o = SimplifiedTrackObjectLinkedFrom(varSimplifiedTrackObjectLinkedFrom)
	}
