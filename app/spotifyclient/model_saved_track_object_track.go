...
type _SavedTrackObjectTrack SavedTrackObjectTrack
...
func (o *SavedTrackObjectTrack) UnmarshalJSON(bytes []byte) (err error) {
	varSavedTrackObjectTrack := _SavedTrackObjectTrack{}

	if err = json.Unmarshal(bytes, &varSavedTrackObjectTrack); err == nil {
		*o = SavedTrackObjectTrack(varSavedTrackObjectTrack)
	}
