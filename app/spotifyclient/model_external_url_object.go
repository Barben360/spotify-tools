...
type _ExternalUrlObject ExternalUrlObject
...
func (o *ExternalUrlObject) UnmarshalJSON(bytes []byte) (err error) {
	varExternalUrlObject := _ExternalUrlObject{}

	if err = json.Unmarshal(bytes, &varExternalUrlObject); err == nil {
		*o = ExternalUrlObject(varExternalUrlObject)
	}
