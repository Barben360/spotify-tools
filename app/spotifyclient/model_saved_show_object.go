...
type _SavedShowObject SavedShowObject
...
func (o *SavedShowObject) UnmarshalJSON(bytes []byte) (err error) {
	varSavedShowObject := _SavedShowObject{}

	if err = json.Unmarshal(bytes, &varSavedShowObject); err == nil {
		*o = SavedShowObject(varSavedShowObject)
	}
