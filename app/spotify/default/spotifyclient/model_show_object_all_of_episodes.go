...
type _ShowObjectAllOfEpisodes ShowObjectAllOfEpisodes
...
func (o *ShowObjectAllOfEpisodes) UnmarshalJSON(bytes []byte) (err error) {
	varShowObjectAllOfEpisodes := _ShowObjectAllOfEpisodes{}

	if err = json.Unmarshal(bytes, &varShowObjectAllOfEpisodes); err == nil {
		*o = ShowObjectAllOfEpisodes(varShowObjectAllOfEpisodes)
	}
