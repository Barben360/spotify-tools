...
type _AlbumObjectAllOfTracks AlbumObjectAllOfTracks
...
func (o *AlbumObjectAllOfTracks) UnmarshalJSON(bytes []byte) (err error) {
	varAlbumObjectAllOfTracks := _AlbumObjectAllOfTracks{}

	if err = json.Unmarshal(bytes, &varAlbumObjectAllOfTracks); err == nil {
		*o = AlbumObjectAllOfTracks(varAlbumObjectAllOfTracks)
	}
