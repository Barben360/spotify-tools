...
type _SavedAudiobookObjectAudiobook SavedAudiobookObjectAudiobook
...
func (o *SavedAudiobookObjectAudiobook) UnmarshalJSON(bytes []byte) (err error) {
	varSavedAudiobookObjectAudiobook := _SavedAudiobookObjectAudiobook{}

	if err = json.Unmarshal(bytes, &varSavedAudiobookObjectAudiobook); err == nil {
		*o = SavedAudiobookObjectAudiobook(varSavedAudiobookObjectAudiobook)
	}
